...
**Verificación:** `GET http://localhost:8029/` responde `"version": "v1"`.
...
docker compose exec api-gestion python pruebas/prueba_capas.py
...
| 6 | El listado y el formulario, con los **dos botones** de guardar | `templates/programas/` |
